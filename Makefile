...
#---------------------------------------------------------------------------------
APP_VER					:= 1
APP_TITLE				:= Persona 5 Entry Test
APP_DESCRIPTION			:= Can I even persona????
APP_AUTHOR				:= DogeDoge
...
LIBS	:= -lavfilter -lswresample -lavformat -lswscale -lavcodec -lavutil -lcitro2d -lcitro3d -lctru -lm

#---------------------------------------------------------------------------------
# list of directories containing libraries, this must be the top level containing
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= library/FFmpeg
LIBDIRS_DEVKITPRO := $(CTRULIB) libctru portlibs/3ds
